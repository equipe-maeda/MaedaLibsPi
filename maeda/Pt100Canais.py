...
class Pt100Canais:
    def __init__(self, canal = 0, qtd_canais = 8):
        ...
        self.G1 = 0.0
        self.canal = canal
        self.class_canais = Canais(qtd_canais = qtd_canais)
        self.dir_dado_canal = ""
        self._set_config()
    ...
    def calibracao(self):
        ...
        while var != "q":
            ...
            v0 = self.adc_1115.readValueFrom() # self.class_canais._get_ad()
            print("V0 = {} e G0 = {}\n".format(v0, g0))
            
            g1 = float(input("Entre com G1 do canal {}\n".format(self.canal)))
            self.class_canais.switch_canal(self.canal)
            v1 = self.adc_1115.readValueFrom()
            print("V1 = {} e G1 = {}\n".format(v1, g1))
...
if __name__ == "__main__":
    ...
    while True:
        test = Pt100(3)
        print(test.temperatura_sistema)
        utime.sleep(1)
